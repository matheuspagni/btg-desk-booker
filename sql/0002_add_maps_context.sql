...
ALTER TABLE maps ADD COLUMN IF NOT EXISTS company TEXT;
ALTER TABLE maps ADD COLUMN IF NOT EXISTS floor TEXT;
ALTER TABLE maps ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW();
ALTER TABLE maps ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
